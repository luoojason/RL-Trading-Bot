...
def main():
    ...
    default_data_path = os.path.join(PROJECT_ROOT, "generated_test_data.csv")
    ...
    stats_path = os.path.join(PROJECT_ROOT, "models", f"model_{args.algo}_eurusd_vecnormalize.pkl")
    ...
    model_name = os.path.join(PROJECT_ROOT, "models", f"model_{args.algo}_eurusd")
